...
import { Mail, Lock, Eye, EyeOff, ArrowRight, User, GraduationCap, Loader2, UserCircle } from 'lucide-react';
...
export default function SignupPage() {
    ...
    const { signUp, googleSignIn, guestSignIn } = useAuth();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            showToast('Account created! Welcome to SwapSociety 🎉', 'success');
            router.push('/');
        } catch (err: unknown) {
            const msg =
        ...
        <div className={styles.page}>
            ...
            >
                <div className={styles.header}>
                    ...
                    <h1 className={styles.title}>Join SwapSociety</h1>
                    <p className={styles.subtitle}>Create your account to start swapping</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className={styles.form}>
                    ...
                    <div className={styles.inputGroup}>
                        ...
                        <input
                            type="email"
                            placeholder="University email (.edu / .ac.in)"
                            value={email}
